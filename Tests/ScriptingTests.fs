...
module Scripting =
    let private testing_aTestCanBeCreated =
        feature "a test" [
    ...
    let private testing_testedByAndTearDown =
        feature "testedBy - teardown" [
    ...
    let private testing_buildingOfTests = 
        [
    ...
    let private testing_namedGroups = 
